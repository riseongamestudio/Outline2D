...
namespace RiseOn.Outline2D {
    ...
    public class OutlineSprite : Outline, IOutlineSprite {
        ...
        [SerializeField, FoldoutGroup("Rendering"), ValueDropdown(nameof(SortingLayers))]
        ...
        [SerializeField, FoldoutGroup("Rendering"), MinValue(short.MinValue), MaxValue(short.MaxValue)]
        protected int sortingOrder;

        [SerializeField, FoldoutGroup("Rendering")]
